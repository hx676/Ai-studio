(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.agent": { zh: "智能体", en: "Agent" },
        "smart.agentSub": { zh: "运行可编辑的智能体 Prompt", en: "Run an editable Agent prompt" },
        "smart.aiWorkflow": { zh: "AI 工作流", en: "AI Workflow" },
        "smart.aiWorkflowSub": { zh: "运行内置结构化工作流", en: "Run a built-in structured workflow" },
